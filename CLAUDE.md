...
- **monsym.se/nadir** (original location): docroot `/var/www/monsym/nadir`. It still runs the old single-file api.php (password-based sharing, no accounts) and shares `/var/lib/nadir/projects` with nadirlab.online.
